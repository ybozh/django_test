...
Documentation can be written as rst files in the `python_freelance_projects_scaner/docs/_source`.
...
from inside the `python_freelance_projects_scaner/docs` directory. 
